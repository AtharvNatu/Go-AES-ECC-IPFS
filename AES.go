...
// AESEncrypt Encrypts the file using AES 128-bit CBC Mode Encryption
func AESEncrypt(inputFile string, outputFile string, encryptionKey []byte) time.Duration {
...
// AESDecrypt Decrypts the file using AES 128-bit CBC Mode Decryption
func AESDecrypt(inputFile string, outputFile string, decryptionKey []byte) time.Duration {
